...
const createCardProduct = () =>{
    const nameProducts = ["Cacao con Canela", "Cacao con Vainilla", "Cacao con Mamey"];
    ...
    const nameProduct3 = document.createElement("h5");
    ...
    const nameProduct4 = document.createElement("h5");
    ...
    const nameProduct5 = document.createElement("h5");
    ...
    const nameProduct6 = document.createElement("h5");
    ...
    const nameProduct7 = document.createElement("h5");
    ...
    const nameProduct8 = document.createElement("h5");
    ...
    const creatingCardBody8 = () =>{
        ...
        cardBody8.appendChild(nameProduct7);
    ...
    const creatingCard8 = () =>{
        ...
        cardContainer8.appendChild(productImage7);
